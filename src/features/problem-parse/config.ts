...
export const questionTypeStemMap: Partial<Record<QuestionType, string>> = {
  purpose: "다음 글의 목적으로 가장 적절한 것은?",
  "emotion-change": "다음 글에 드러난 X의 심경 변화로 가장 적절한 것은?",
  claim: "다음 글에서 필자가 주장하는 바로 가장 적절한 것은?",
  "underline-meaning": "밑줄 친 _____가 다음 글에서 의미하는 바로 가장 적절한 것은?",
  gist: "다음 글의 요지로 가장 적절한 것은?",
  ...
  blank: "다음 빈칸에 들어갈 말로 가장 적절한 것은 고르시오.",
  "irrelevant-sentence": "다음 글에서 전체 흐름과 관계 없는 문장은?",
  "sentence-order": "주어진 글 다음에 이어질 글의 순서로 가장 적절한 것을 고르시오",
  "sentence-insertion": "글의 흐름으로 보아, 주어진 문장이 들어가기에 가장 적절한 곳을 고르시오.",
  "summary-blank":
